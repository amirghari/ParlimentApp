package com.example.parlimentapp.data
...
object ParliamentMembersData {
    ...
    data class ParliamentMember(val hetekaId: Int, val seatNumber: Int, val lastname: String, val firstname: String, val pictureUrl: String, val party: String, val minister: Boolean)
}
